...
def main():
    st.title('Pré análise')
    st.subheader('Que espécie de dados temos aqui ?')
    st.image('https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTkm0UuydwCSTSWG9PkvOKsmgn0Vr-GIj6PpSrVa9Azvjihko_G&usqp=CAU', width=200)
